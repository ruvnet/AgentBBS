...
| [0023](0023-arena-retort-metaharness-track.md) | Arena — Retort-MetaHarness DoE/ANOVA track; ranks agent+harness+model *stacks* by `requirement_coverage` at binned `$/task`, ANOVA factor attribution, TOOLING/GENUINE honest scoring; reuses ADR-0011 signed submissions | Accepted |
